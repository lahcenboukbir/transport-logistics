        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="col">
                <div class="p-2">
                    ...
                    <p class="text-white text-opacity-75 text-capitalize">{{ $role->name ?? 'N/A' }}</p>
                </div>
            </div>
                                ...
                                <div class="card">
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ $user->created_at ?? 'N/A' }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <div>
                                                <a href="mailto:{{ $user->email }}" class="avatar-xs d-block"
                                                    title="Email">
                                                    <span
                                            ...
                                            <div>
                                                <a href="tel:{{ $user->phone_number }}" class="avatar-xs d-block"

            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Liste des ports</li>
                    </ol>
                </div>
            ...
            <div class="card">
                @can('create ports')
                    <div class="card-header">
                        <div>
                            <a href="{{ route('ports.create') }}" class="btn btn-success btn-label waves-effect waves-light">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            @can('edit ports')
                                                {{-- edit --}}
                                                <a href="{{ route('ports.edit', $port->id) }}" type="button"
                                            ...
                                            @can('delete ports')
                                                ...
                                                <button class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal"
                                                    data-bs-target="#deleteRecordModal{{ $port->id }}" title="Supprimer">
                                                    <i class="ri-delete-bin-line"></i>
                                                </button>

                                                {{-- delete modal --}}
                                                <div class="modal fade zoomIn" id="deleteRecordModal{{ $port->id }}"

    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">Équipements</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="#">Accueil</a></li>
                        <li class="breadcrumb-item active">Liste des équipements</li>
                    </ol>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            @can('edit equipments')
                                                {{-- edit --}}
                                                <a href="{{ route('equipments.edit', $equipment->id) }}" type="button"
                                            ...
                                            @can('delete equipments')
                                                ...
                                                <button class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal"
                                                    data-bs-target="#deleteRecordModal{{ $equipment->id }}" title="Supprimer">
                                                    <i class="ri-delete-bin-line"></i>
                                                </button>

                                                {{-- delete modal --}}
                                                <div class="modal fade zoomIn" id="deleteRecordModal{{ $equipment->id }}"

...
@section('content')
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4 align-items-center">
            ...
            <div class="col">
                <div class="p-2">
                    <h3 class="text-white mb-1">{{ $prospect->name }}</h3>
                    <p class="text-white text-opacity-75">{{ $prospect->company }}</p>
                </div>
            </div>
                                ...
                                <div class="card">
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ $prospect->name }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Entreprise :</th>
                                                        <td class="text-muted">{{ $prospect->company }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">ICE :</th>
                                                        <td class="text-muted">{{ $prospect->ice ?? 'N/A' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Email :</th>
                                                        <td class="text-muted">{{ $prospect->email }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Numéro de téléphone :</th>
                                                        <td class="text-muted">{{ $prospect->phone_number ?? 'N/A' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Ville :</th>
                                                        <td class="text-muted">{{ $prospect->city ?? 'N/A' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Activité :</th>
                                                        <td class="text-muted">{{ $prospect->activity ?? 'N/A' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Statut :</th>
                                                        <td class="text-muted">{{ $prospect->status ?? 'N/A' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Remarques :</th>
                                                        <td class="text-muted">{{ $prospect->notes ?? 'N/A' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ $prospect->created_at ?? 'N/A' }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <div>
                                                <a href="mailto:{{ $prospect->email }}" class="avatar-xs d-block"
                                                    title="Email">
                                                    <span
                                            ...
                                            <div>
                                                <a href="tel:{{ $prospect->phone_number }}" class="avatar-xs d-block"

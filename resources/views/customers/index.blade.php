            ...
            <div class="card">
                @can('assign customers')
                    <div class="card-header">
                        ...
                        <div id="addModal" class="modal zoomIn" tabindex="-1" aria-hidden="true" style="display: none;">
                                ...
                                <div class="modal-content border-0 overflow-hidden">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('customers.store') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label for="prospect" class="form-label">Prospects</label>
                                            ...
                                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Fermer
                                                </button>
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            @can('delete customers')
                                                ...
                                                <button class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal"
                                                    data-bs-target="#deleteRecordModal{{ $customer->id }}" title="Supprimer">
                                                    <i class="ri-delete-bin-line"></i>
                                                </button>

                                                {{-- delete modal --}}
                                                <div class="modal fade zoomIn" id="deleteRecordModal{{ $customer->id }}"
